...
export const Route = createFileRoute("/services")({
  head: () => ({
    meta: [
      { title: "Layanan BARIS — Culture, Talent, Solution" },
      { name: "description", content: "Tiga pilar layanan BARIS: Culture Transformation, Talent, dan Solution." },
    ],
  }),
  ...
  return (
    <PageShell>
      <PageHero
        ...
        title="Tiga pilar untuk akselerasi bisnis Anda."
        description="Culture Transformation, Talent, dan Solution — solusi terintegrasi untuk membantu organisasi bertumbuh dan berinovasi."
      />
